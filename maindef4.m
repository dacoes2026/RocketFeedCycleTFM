...
BaselineValues = [
    ...
    data.P54; data.T54; data.v54; data.M54; data.A54; data.P17; ...
    data.T17; data.P28; data.T28; ...
    data.P10; data.P15; data.P18; data.P34; data.P23; data.T23; data.P40; data.P41; data.P50
];
...
errorP34= ((results.P34-data.P34)/data.P34)*100;
...
RowNames = {
    ...
    'M51'; 'A51 [m^2]'; ...
    'P52 [bar]'; 'T52 [K]'; 'v52 [m/s]'; 'M52'; 'A52 [m^2]'; ... 
    'P53 [bar]'; 'T53 [K]'; 'v53 [m/s]'; 'M53'; 'A53 [m^2]'; ... 
    'P54 [bar]'; 'T54 [K]'; 'v54 [m/s]'; 'M54'; 'A54 [m^2]'; 'P17 [bar]'; ...
    'T17 [K]'; 'P28 [bar]'; 'T28 [K]'; ...
    'P10 [bar]'; 'P15 [bar]'; 'P18 [bar]'; 'P34 [bar]'; 'P23 [bar]'; 'T23 [K]'; 'P40 [bar]'; 'P41 [bar]'; 'P50 [bar]'
};
% 
SolvedValues = [
    ...
    results.P52; results.T52; results.v52; results.M52; results.A52; ... 
    results.P53; results.T53; results.v53; results.M53; results.A53; ... 
    results.P54; results.T54; results.v54; results.M54; results.A54; results.P17; ...
    results.T17; results.P28; results.T28; ...
    results.P10; results.P15; results.P18; results.P34; results.P23; results.T23; results.P40; results.P41; results.P50
];
% 
...
RelativeErrors_pct = [
    ...
    errorM51; errorA51; ...
    errorP52; errorT52; errorv52; errorM52; errorA52; ... 
    errorP53; errorT53; errorv53; errorM53; errorA53; ... 
    errorP54; errorT54; errorv54; errorM54; errorA54; errorP17; ...
    errorT17; errorP28; errorT28; ...
    errorP10; errorP15; errorP18; errorP34; errorP23; errorT23; errorP40; errorP41; errorP50
];
